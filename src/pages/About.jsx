    ...
    <>
      ...
      <section className="bg-jc-black-soft py-16 border-y border-white/10">
        <div className="mx-auto max-w-6xl px-4 lg:px-8 grid grid-cols-3 gap-6 text-center">
          ...
          <div><p className="text-3xl font-black text-jc-orange-primary">10,000+</p><p className="text-xs uppercase tracking-wide text-jc-gray-steel">Repairs Completed</p></div>
